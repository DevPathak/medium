...
export const Publish = () => {
    ...
    return <div> 
        ...
        <div className="flex justify-center pt-8"> 
            ...
            }} type="text" id="large-input" className="focus:outline-none block w-full p-4 text-gray-900 border border-gray-300 
            rounded-lg bg-gray-50 text-base focus:ring-blue-500
            dark:placeholder-gray-400 dark:focus:ring-blue-500" placeholder="Title" />
...
function TextEditor({ onChange }: {onChange: (e: ChangeEvent<HTMLTextAreaElement>) => void}) {
    return <div>
       <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 my-2">
           ...
           <div className="bg-white rounded-b-lg">
               ...
               <textarea onChange={onChange} id="editor" rows={9} className="focus:outline-none block w-full px-0 text-sm text-gray-800 bg-white border-0 focus:ring-0 dark:placeholder-gray-400 pl-2" placeholder="Write an article..." required ></textarea>
           </div>
       </div>
    </div>
