...
import { InputSignupObject } from "@devpathak_7/mediumcomm"
import axios from "axios"
import { BACKEND_URL } from "../config"

export const Auth = ({ type }: { type: "signup" | "signin" }) => {
    const navigate = useNavigate()
    const [postInputs, setPostInputs] = useState<InputSignupObject>({
        name: "",
        username: "",
        password: ""
    })
    ...
    return <div className="h-screen flex justify-center flex-col">
        ...
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-4">
                    {type === "signup" ? <LabelledInput label="Name" placeholder="Dev Pathak..." onchange={(e) => {
                        setPostInputs(c => ({
                            ...c,
                            name: e.target.value
                        }))
                    }} /> : null}
                    <LabelledInput label="Username" placeholder="devesh.pathak@gmail.com" onchange={(e) => {
                        setPostInputs(c => ({
                            ...c,
